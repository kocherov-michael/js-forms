$(document).ready(function(){
	...
	var registrationFormCheck = (function(){
		...
		var _emailErrorWrong = $('<div id="registration-email-wrong" class="notify notify--error mb-20 notify-hide">Неверный формат email</div>');
		var _passwordErrorEmpty = $('<div id="registration-password-empty" class="notify notify--error mb-20 notify-hide">Введите пароль</div>');
		var _emailErrorExist = $('<div id="registration-email-exist" class="notify no-paddings notify-hide"><div class="notify no-radius-bottom notify--error">Данный email уже занят</div><div class="notify no-radius-top"><p>Используйте другой email чтобы создать новый аккаунт.</p><p> Или воспользуйтесь<a href="#!">восстановлением пароля </a>, чтобы войти на сайт.</p></div></div>');
